...
![alt-text-1](Documentacion/Itype_Registro.png )  ![alt-text-2](Documentacion/IType_inicio.png )

## Menu :

![alt-text-1](Documentacion/Itype_dific.png ) ![alt-text-2](Documentacion/Itype_Menu.png )

## Prueba : 

![alt-text-1](Documentacion/IItype_prueba.png ) 

## Resultados :

![alt-text-2](Documentacion/itype_results.png ) ![alt-text-2](Documentacion/Itype_datos.png )

## Arquitectura del sistema (http web hosted sql routines & app):

![alt-text-2](Documentacion/arquitectura.png)